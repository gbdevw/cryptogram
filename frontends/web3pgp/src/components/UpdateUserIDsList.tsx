...
import { UpdateUserMetadata } from '../hooks/useProcessUpdateKey'

interface UpdateUsersListProps {
  users: UpdateUserMetadata[]
}

/**
 * Displays the list of user IDs from the merged key with their statuses
 * Shows name, email, and comment for each user ID (if present)
 * Displays verification status: VALID or REVOKED
 * Based on UserIDsList pattern from Find page
 */
export function UpdateUserIDsList({ users }: UpdateUsersListProps) {
