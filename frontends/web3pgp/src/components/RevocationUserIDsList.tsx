...
interface RevocationUserIDsListProps {
  users: UserIDMetadata[]
}

/**
 * Displays the list of user IDs for the revocation workflow with their statuses
 * Shows name, email, and comment for each user ID (if present)
 * Displays verification status: VALID or REVOKED
 */
export function RevocationUserIDsList({ users }: RevocationUserIDsListProps) {
