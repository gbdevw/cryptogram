...
contract Web3SignTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy and initialize Web3Sign
        Web3Sign docImpl = new Web3Sign();
        bytes memory docInitData = abi.encodeCall(Web3Sign.initialize, (uint256(0), address(docAccessManager), address(pgp)));
        ERC1967Proxy docProxy = new ERC1967Proxy(address(docImpl), docInitData);
        doc = Web3Sign(payable(address(docProxy)));
        ...
        // Configure permissions for Web3Sign
    ...
    function testSendOnChainEmitsDocumentEvent() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, signature, document, "text/plain");
    }
    ...
    function testSendOffChainEmitsDocumentEvent() public {
        ...
        doc.sendOffChain(emitter, new IWeb3Sign.Recipient[](0), dochash, signature, uri, "application/pdf");
    ...
    function testCopyOnChainAndIsCopyOf() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s", "orig-doc", "text/plain");

        doc.copyOnChain(1, emitter, new IWeb3Sign.Recipient[](0), "copied-doc");
    ...
    function testCopyOffChainRevertsWhenOriginalIsCopy() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s2", "orig2", "text/plain");
        doc.copyOffChain(1, emitter, new IWeb3Sign.Recipient[](0), "ipfs://copy");

        vm.expectRevert();
        doc.copyOffChain(2, emitter, new IWeb3Sign.Recipient[](0), "ipfs://copy2");
    }
    ...
    function testSendOnChainWithRecipientsEmitsNotification() public {
        ...
        IWeb3Sign.Recipient[] memory recs = new IWeb3Sign.Recipient[](1);
        recs[0] = IWeb3Sign.Recipient({fingerprint: recipientFp, signatureRequested: true});
        ...
        emit Notification(1, emitter, recipientFp, IWeb3Sign.EventType.DOCUMENT, true);
    ...
    function testSendOffChainWithRecipientsEmitsNotification() public {
        ...
        IWeb3Sign.Recipient[] memory recs = new IWeb3Sign.Recipient[](1);
        recs[0] = IWeb3Sign.Recipient({fingerprint: recipientFp, signatureRequested: false});

        vm.expectEmit(true, true, true, false, address(doc));
        emit Document(1, emitter, keccak256("dh"), "s", new bytes(0), "uri", "text/plain");

        vm.expectEmit(true, false, true, false, address(doc));
        emit Notification(1, emitter, recipientFp, IWeb3Sign.EventType.DOCUMENT, false);
    ...
    function testCopyCreatesCorrectMapping() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("orig"), "s", "orig", "text/plain");
        doc.copyOnChain(1, emitter, new IWeb3Sign.Recipient[](0), "copy");
    ...
    function testCopyOnChainRevertsWhenOriginalIsCopy() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("o"), "s", "orig", "text/plain");
        doc.copyOnChain(1, emitter, new IWeb3Sign.Recipient[](0), "copy1");

        vm.expectRevert();
        doc.copyOnChain(2, emitter, new IWeb3Sign.Recipient[](0), "copy-of-copy");
    }
    ...
    function testSignAndListSignaturesPagination() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("d"), "s", "doc", "text/plain");
    ...
    function testListSignaturesEdgeCases() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("d-edge"), "s", "doc", "text/plain");
    ...
    function testGetDocumentBlockNumberByIDBatchAndTimestamp() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("d1"), "s1", "doc1", "text/plain");
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("d2"), "s2", "doc2", "text/plain");
    ...
    function testRecipientNotFoundReverts() public {
        ...
        IWeb3Sign.Recipient[] memory recs = new IWeb3Sign.Recipient[](1);
        recs[0] = IWeb3Sign.Recipient({fingerprint: nonExistentRecipient, signatureRequested: false});
    ...
    function testEmitterNotFoundReverts() public {
        ...
        vm.expectRevert();
        doc.sendOnChain(nonExistentEmitter, new IWeb3Sign.Recipient[](0), keccak256("d"), "s", "doc", "text/plain");
    }
    ...
    function testUpgraderCanUpgrade() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("doc"), "sig", "data", "text/plain");
        
        uint256 blockNum = doc.getDocumentBlockNumberByID(1);
        assertTrue(blockNum != 0);
        
        // Setup upgrader role for Web3Sign
        vm.startPrank(admin);
    ...
    function testUpgradePreservesAllState() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("d1"), "s1", "doc1", "text/plain");
        doc.sendOffChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("d2"), "s2", "ipfs://doc2", "text/plain");
        doc.timestamp(emitter, keccak256("ts"), "ts-sig");
        ...
        // Copy a document
        doc.copyOnChain(1, emitter, new IWeb3Sign.Recipient[](0), "copy-data");
        ...
        doc.sendOnChain(newEmitter, new IWeb3Sign.Recipient[](0), keccak256("new"), "new-sig", "new-doc", "text/plain");
    ...
    function testTreasurerCanWithdrawFees() public {
        ...
        vm.prank(alice);
        doc.sendOnChain{value: 0.5 ether}(emitter, new IWeb3Sign.Recipient[](0), keccak256("d"), "s", "doc", "text/plain");
    ...
    function testMultipleSignaturesByDifferentEmitters() public {
        ...
        doc.sendOnChain(em1, new IWeb3Sign.Recipient[](0), keccak256("d"), "s", "doc", "text/plain");
    ...
    function testCopyOffChainEmitsCopyEvent() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), keccak256("orig"), "s", "orig-doc", "text/plain");
    ...
    function testCopyOnChainWithRecipientsEmitsNotification() public {
        ...
        IWeb3Sign.Recipient[] memory recs = new IWeb3Sign.Recipient[](1);
        recs[0] = IWeb3Sign.Recipient({fingerprint: recipient, signatureRequested: true});
        
        vm.expectEmit(true, true, true, false, address(doc));
        emit Copy(2, 1, emitter, "copy-data", "");
        
        vm.expectEmit(true, false, true, false, address(doc));
        emit Notification(2, emitter, recipient, IWeb3Sign.EventType.COPY, true);
    ...
    function testCopyOffChainWithRecipientsEmitsNotification() public {
        ...
        IWeb3Sign.Recipient[] memory recs = new IWeb3Sign.Recipient[](1);
        recs[0] = IWeb3Sign.Recipient({fingerprint: recipient, signatureRequested: false});
        
        vm.expectEmit(true, true, true, false, address(doc));
        emit Copy(2, 1, emitter, new bytes(0), "ipfs://copy");
        
        vm.expectEmit(true, false, true, false, address(doc));
        emit Notification(2, emitter, recipient, IWeb3Sign.EventType.COPY, false);
    ...
    function testSendWithMultipleRecipients() public {
        ...
        IWeb3Sign.Recipient[] memory recs = new IWeb3Sign.Recipient[](3);
        recs[0] = IWeb3Sign.Recipient({fingerprint: rec1, signatureRequested: true});
        recs[1] = IWeb3Sign.Recipient({fingerprint: rec2, signatureRequested: false});
        recs[2] = IWeb3Sign.Recipient({fingerprint: rec3, signatureRequested: true});
    ...
    function testListDocumentIdsByHashBasic() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s1", "doc1", "text/plain");
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s2", "doc2", "text/plain");
        doc.timestamp(emitter, dochash, "ts-sig");
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s3", "doc3", "text/plain");
    ...
    function testListDocumentIdsByHashPagination() public {
        ...
        for (uint256 i = 0; i < 6; i++) {
            doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, abi.encodePacked("sig", i), abi.encodePacked("doc", i), "text/plain");
        }
    ...
    function testListDocumentIdsByHashDifferentHashes() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), hash1, "s1", "doc1", "text/plain");
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), hash2, "s2", "doc2", "text/plain");
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), hash1, "s3", "doc3", "text/plain");
    ...
    function testListDocumentIdsByHashStartOutOfBounds() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s", "doc", "text/plain");
    ...
    function testListDocumentIdsByHashMixedDocumentTypes() public {
        ...
        doc.sendOnChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s1", "doc1", "text/plain");
        doc.sendOffChain(emitter, new IWeb3Sign.Recipient[](0), dochash, "s2", "ipfs://doc2", "text/plain");
        doc.timestamp(emitter, dochash, "ts-sig");
        doc.copyOnChain(1, emitter, new IWeb3Sign.Recipient[](0), "copy-doc");
