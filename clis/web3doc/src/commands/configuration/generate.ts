...
export function generateConfigTemplate(environment: 'test' | 'prod' = 'test'): string {
  if (environment === 'test') {
    return `# Web3Doc CLI Configuration - TEST Environment
# Location: ~/.web3doc/config.yaml
# 
# This file configures the Web3Doc CLI for the TEST environment.
...
`;
    ...
    return `# Web3Doc CLI Configuration - PRODUCTION Environment
# Location: ~/.web3doc/config.yaml
# 
# This file configures the Web3Doc CLI for the PRODUCTION environment.
# You can override any value using:
# - Environment variables (DEXES_* prefix)
# - Command-line flags
#
